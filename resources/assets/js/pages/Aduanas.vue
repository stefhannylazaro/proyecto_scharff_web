<template>
  ...
  <v-container fluid class="pa-0">
    <v-layout row wrap>
      <v-flex xs12 :class="{hVhAduanas: isValid}" class="cover-height  bg-smoke">
        <div style="position:inline-block; width:100%;max-width:1440px">
          ...
          <carousel
                ...
                <slide style="height:100%;" v-if="sliContenidos" v-for="(el, ind) in sliContenidos" :key="ind">
                  ...
                  <v-container style="height:100%;" fluid class="pb-0 px-0 ma-0">
                    ...
                    :style="'background-image:url(/elements/banner/'+el.imagen+')'">
                      <v-flex xs12 sm6 md6 lg6 xl8 class="cover-col">
                        <div class="coverThreeLeft">
                          ...
                          <a href="#" v-scroll-to="'#aduanas-s-b'" class="icon-position-center">
                ...
                <slide style="height:100%;" v-if="sliderDefault">
                  <v-container style="height:100%;" fluid class="pb-0 px-0 ma-0">
                    <v-layout style="height:100%;" row wrap class="wrapper-cover bg-slotTree"
                    :style="'background-image:url(/images/inner-a/img_aduanas.png)'">
                      <v-flex xs12 sm6 md6 lg6 xl8 class="cover-col">
                        <div class="coverThreeLeft">
                          <div class="container-left d-flex justify-center ">
                            <div class="d-flex pl-2 px-5">
                              ...
                              <div>
                                <p class="send mb-0 black--text">Crecer no tiene <br>límites </p>
                              </div>
                              <span class="mt-2">Más de 30 años de gestión y asesoría personalizada de aduanas</span>
                            </div>
      ...
      <v-flex  xs12 :class="{hVhSections: isValid}" class="cover-height" id="aduanas-s-b">
        <div style="position:inline-block; width:100%;max-width:1440px">


          <v-container fluid class="bg-estandar-full d-align-center full-height bg-estandar-centered"
          style="background-image:url('/images/inner-a/img_aduanas_section2.png')">
        			...
        			<v-layout>
        				<v-flex xs12 offset-sm6 sm6 class="d-column-justify-right text-right order-0 d-column-justify-center pr3">
        			        <p class="  font-bold pb-3 cImg-text-subtitle ma-0">
        			        	La asesoría que<br> tu empresa necesita
        			        </p>
        			        <p class="  font-light cImg-text-content ma-0">
                        Que expandir tu negocio no sea un problema. Te<br> brindamos soluciones y asesorías personalizadas<br> para la gestión aduanera de tu negocio.
                      </p>
        			        <div class="py-3 d-justify-right">
                        <v-btn round large outline class="cover gi-16" v-scroll-to="'#formGrow'">&nbsp;&nbsp;Cotizar&nbsp;&nbsp;</v-btn>
        			        </div>
        				</v-flex>
        			</v-layout>
        		</v-container>
      ...
      <v-flex  xs12 :class="{hVhSections: isValid}" class="cover-height  ">
        <div style="position:inline-block; width:100%;max-width:1440px">
          ...
          <v-container fluid class="bg-estandar-full d-align-center full-height bg-estandar-centered"
          style="background-image:url('/images/inner-a/img_aduanas_section3.png')">
        		<v-container style="max-width:1440px">
        			<v-layout>
        				<v-flex xs12  sm6 class="d-column-justify-right text-left order-0 d-column-justify-center pl3">
    			        <p class="  font-bold pb-3 cImg-text-subtitle ma-0">
    			        	Estamos en todos los puertos <br>del Perú </p>
    			        <p class="  font-light cImg-text-content ma-0">
    			          Nuestras oficinas a nivel nacional le dan flexibilidad <br>a tus operaciones.</p>
    			        <div class="py-3 d-justify-right">
                    <v-btn round large outline class="cover gi-16" v-scroll-to="'#formGrow'">&nbsp;&nbsp;Cotizar&nbsp;&nbsp;</v-btn>
    			        </div>
        				</v-flex>
...
import howtowork from '../components/cExpressHowToWork.vue'
