...
<html>
    <head>
        <title>Rastro a tu pedido</title>
                                                            ...
                                                            <table cellspacing="0" cellpadding="0" width="90%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <tr>
                                                        <td><h3 style="margin-bottom: 0;"><strong style="color: #ff7177;font-size: 26px;">Hazle seguimiento a tu envío</strong></h3></td>
                                                    </tr>
                                                            ...
                                                            <table cellpadding="0" cellspacing="15" width="100%;">
                                                                <tbody>
                                                                	<tr>
                                                                        ...
                                                                        <td>
                                                                            <p><strong style="">{{$obj["regular_codetracking"]}} </strong></p>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <p><a href="{{$obj["link"]}}">Ingresar</a></p>
                                                                            <hr style="border: 0;background-color: #ff7177;height: 1px;">
                                                                        </td>
                                                                    </tr>
