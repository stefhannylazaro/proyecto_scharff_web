                                                            ...
                                                            <table cellspacing="0" cellpadding="0" width="90%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <tr>
                                                        <td><h3><strong style="color: #ff7177;font-size: 26px;">Hola usuario</strong></h3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>

<p>La nueva contraseña es: {{ ucwords($clave)}}</p>
<p>Puedes cambiarla en el menú derecho "Mi Cuenta" de tu panel de usuario.</p>
<p><a href="http://holascharff.com/" target="_blank" style="color: #ff7177;">Iniciar sesión en Scharff.</a></p>
                                                        </td>
                                                    </tr>
