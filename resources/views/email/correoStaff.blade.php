                ...
                <table class="email-table w320" style="background-color: #ffffff;width: 600px;" width="600" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        <tr>
                            <td align="center">
                                <center>
                                    <table cellpadding="0" cellspacing="0" border="0" width="85%" style="width: 80%">
                                        <tr><td height="30">&nbsp;</td></tr>
                                        <tr>
                                            <td align="left">
                                                <h1 style="font-size: 25px;">¡Hola Administrador!</h1>
                                                <p style="font-size: 13px;line-height: 20px;margin: 0;">{{$obj->mensaje_staff}}</p>
                                                            ...
                                                            <table cellspacing="0" cellpadding="0" width="90%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <tr>
                                                        <td><h3><strong style="color: #ff7177;font-size: 26px;">Correo de contacto</strong></h3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="15" width="100%;">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p><strong style="">{{ucwords($obj->nombre)}} </strong></p>
                                                                            <hr style="border: 0;background-color: #ff7177;height: 1px;">
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p><strong style="">{{$obj->created_at}}.</strong></p>
                                                                            <hr style="border: 0;background-color: #ff7177;height: 1px;">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p><strong>{{$obj->contacto}}</strong></p>
                                                                            <hr style="border: 0;background-color: #ff7177;height: 1px;">
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p><strong>{{$obj->servicios}}</strong></p>
                                                                            <hr style="border: 0;background-color: #ff7177;height: 1px;">
                                                                        </td>
                                                                    </tr>
                                                                                                                                            <tr>
