...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        })(window,document,'script','dataLayer','GTM-5C6V7MM');</script>
        ...
        <link rel="stylesheet" type="text/css" href="{{ mix('css/app.css') }}?502">
...
@endif
    ...
    <body class="{{env('APP_ENV','devel')==='production'?'holascharff_body':'scharff_devel_body'}}">
      ...
      <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5C6V7MM"
    ...
    <script src="{{ mix('js/app.js') }}?502"></script>
