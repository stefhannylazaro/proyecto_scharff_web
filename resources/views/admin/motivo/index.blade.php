      ...
      <div class="widget widget-fullwidth widget-small">
        <div class="widget-head">
          <div class="tools input-group-btn">
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <li>
                  <a href="{{route('adm.motivo.new')}}" class="m-nav__link">
        ...
        <table id="table1" class="table table-striped table-fw-widget table-hover">
          <thead>
            <tr>
              <th>
                <a href="{{  route('adm.motivo.order',['column-1', $order, 'pager' => $pager, 'search' => $search])}}">
                  Motivo
                  @if($column == 'column-1')
              ...
              <th>
                <a href="{{  route('adm.motivo.order',['column-2', $order, 'pager' => $pager, 'search' => $search])}}">
                  Correo
                  @if($column == 'column-2')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
              ...
              <th>
                <a href="{{  route('adm.motivo.order',['column-3', $order, 'pager' => $pager, 'search' => $search])}}">
                  Orden
                  @if($column == 'column-3')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
              ...
              <th>
                <a href="{{  route('adm.motivo.order',['column-4', $order, 'pager' => $pager, 'search' => $search])}}">
              ...
              <th>
                <a href="{{  route('adm.motivo.order',['column-5', $order, 'pager' => $pager, 'search' => $search])}}">
              ...
              <th>
                <a href="{{  route('adm.motivo.order',['column-6', $order, 'pager' => $pager, 'search' => $search])}}">
                  Fecha Creación
                  @if($column == 'column-6')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>
                  <span style="width: 200px;">{{ $model->orden }}</span>
              </td>

              <td>
                  <span style="width: 200px;">{{ substr($model->mensaje_personalizado_staff, 0, 30).'...' }}</span>
              </td>
              <td>
                  <span style="width: 200px;">{{ substr($model->mensaje_personalizado_cliente, 0, 30).'...' }}</span>
              </td>

              <td>
                  <span style="width: 200px;">{{ $model->created_at }}</span>
              </td>
              <td class="text-center"><a href="{{ route('adm.motivo.edit',$model->id) }}" class="ver-detail-item"
                 title="Ver">
