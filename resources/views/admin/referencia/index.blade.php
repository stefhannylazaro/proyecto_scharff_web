...
@section('title')
    Administracion | Tipos de usuario
@endsection
      ...
      <div class="widget widget-fullwidth widget-small">
        <div class="widget-head">
          <div class="tools input-group-btn">
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <li>
                  <a href="{{route('adm.referencia.new')}}" class="m-nav__link">
          ...
          <div class="title">Lista de tipos de usuario</div>
        </div>
        ...
        <table id="table1" class="table table-striped table-fw-widget table-hover">
          <thead>
            <tr>
              <th>
                <a href="{{  route('adm.referencia.order',['column-1', $order, 'pager' => $pager, 'search' => $search])}}">
                  id
                  @if($column == 'column-1')
              ...
              <th>
                <a href="{{  route('adm.referencia.order',['column-2', $order, 'pager' => $pager, 'search' => $search])}}">
                  Nombre
                  @if($column == 'column-2')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              <td>{{ $model->id }}</td>
              <td>{{ $model->nombre }}</td>
              <td>{{ 'https://holascharff.com/registro?tipo='.$model->nombre }}</td>
              <td class="text-center">
                <a href="{{ route('adm.referencia.edit',$model->id) }}" class="ver-detail-item" title="Ver">
