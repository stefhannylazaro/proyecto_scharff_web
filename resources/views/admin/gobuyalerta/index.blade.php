        ...
        <div class="widget-head">
          <div class="tools input-group-btn">
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <li>
                  <a href="{{route('adm.gobuyalerta.new')}}" class="m-nav__link">
          ...
          <div class="title">Lista de alertas gobuy</div>
        </div>
            ...
            @if(count($models))
              @foreach($models as $model)
                <tr class="odd gradeX">
                  ...
                  <td>
                      <span style="width: 200px;">{{ $model->alerta_descripcion }}</span>
                  </td>
                  <td>
                      <span style="width: 200px;">{{ $model->alerta_fecha }}</span>
                  </td>
                  <td>
                      <span style="width: 200px;">{{ $model->created_at }}</span>
                  </td>
                  <td class="text-center"><a href="{{ route('adm.gobuyalerta.edit',$model->id) }}" class="ver-detail-item"
                     title="Ver">
