      ...
      <div class="widget widget-fullwidth widget-small">
        <div class="widget-head">
          <div class="tools input-group-btn">
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <li>
                  <a href="{{route('adm.servicio.new')}}" class="m-nav__link">
          ...
          <div class="title">Lista de Servicios</div>
        </div>
        ...
        <table id="table1" class="table table-striped table-fw-widget table-hover">
          <thead>
            <tr>
              <th>
                <a href="{{  route('adm.servicio.order',['column-1', $order, 'pager' => $pager, 'search' => $search])}}">
                  Título
                  @if($column == 'column-1')
              ...
              <th>
                <a href="{{  route('adm.servicio.order',['column-2', $order, 'pager' => $pager, 'search' => $search])}}">
                  Orden
                  @if($column == 'column-2')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
              ...
              <th>
                <a href="{{  route('adm.servicio.order',['column-3', $order, 'pager' => $pager, 'search' => $search])}}">
                  Fecha Creación
                  @if($column == 'column-3')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>
                <img  src="/{{config('app.url_image_servicio')}}/{{ $model->imagen }}" alt="" width="60px"/>
              </td>
              <td class="text-center"><a href="{{ route('adm.servicio.edit',$model->id) }}" class="ver-detail-item"
                 title="Ver">
