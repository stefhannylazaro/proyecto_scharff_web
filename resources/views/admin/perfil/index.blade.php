      ...
      <div class="widget widget-fullwidth widget-small">
        <div class="widget-head">
          <div class="tools input-group-btn">
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <li>
                  <a href="{{route('adm.perfil.new')}}" class="m-nav__link">
          ...
          <div class="title">Lista de Perfiles</div>
        </div>
        ...
        <table id="table1" class="table table-striped table-fw-widget table-hover">
          <thead>
            <tr>
              <th>
                <a href="{{  route('adm.perfil.order',['column-1', $order, 'pager' => $pager, 'search' => $search])}}">
                  Nombre de Perfil
                  @if($column == 'column-1')
              ...
              <th>
                <a href="{{  route('adm.perfil.order',['column-2', $order, 'pager' => $pager, 'search' => $search])}}">
                  Número de usuarios
                  @if($column == 'column-2')
                      <span class="glyphicon glyphicon-sort-by-attributes{{$order == 'desc'? '':'-alt'}}"></span>
                  @endif
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="text-center">
                <a href="{{ route('adm.perfil.edit',$model->id) }}" class="ver-detail-item"
                 title="Ver">
