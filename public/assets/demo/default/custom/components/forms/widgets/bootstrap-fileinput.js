...
+function ($) { "use strict";
  ...
  Fileinput.prototype.change = function(e) {
    ...
    var file = files[0]
    if (this.$preview.length > 0 && (typeof file.type !== "undefined" ? file.type.match(/^image\/(gif|svg\+xml|png|jpeg)$/) : file.name.match(/\.(gif|svg\+xml|png|jpe?g)$/i)) && typeof FileReader !== "undefined") {
      ...
      reader.onload = function(re) {
        var $img = $('<img>');
        $img.css('width', preview.css('width') )
